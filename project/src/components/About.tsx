      ...
      >
        <motion.div variants={fadeIn} className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-gray-300 text-lg leading-relaxed">
            <p>
              At Noto, we're revolutionizing healthcare documentation with AI-powered solutions. 
              Our system streamlines workflows, reduces errors, and integrates seamlessly with 
              hospital management systems.
            </p>
            <p>
              Tailored for the Jordanian healthcare market, we focus on minimizing administrative 
              burdens, enabling doctors to spend more time caring for patients.
            </p>
          </div>
        </motion.div>
