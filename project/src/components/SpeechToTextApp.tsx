...
const SpeechToTextApp: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-white mb-6 text-center">Voice Recognition</h2>
      <div
          ...
          {signature ? (
            <div className="w-full max-w-2xl mx-auto p-4 bg-gray-900 rounded-lg border border-emerald-500/30">
              <div className="flex justify-between items-center mb-2">
                <span className="text-emerald-500 font-medium">Signature Added</span>
                <button
              ...
              {signature.type === 'type' ? (
                <p className="font-signature text-xl text-white">{signature.data}</p>
              ) : (
                <img src={signature.data} alt="Signature" className="max-h-20 mx-auto" />
              )}
